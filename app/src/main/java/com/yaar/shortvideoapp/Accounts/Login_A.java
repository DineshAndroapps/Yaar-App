package com.yaar.shortvideoapp.Accounts;
...
public class Login_A extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString ssplo = new SpannableString("and have read and understood \n our Privacy Policy.");
        ClickableSpan clickableSpanpoli = new ClickableSpan() {
            @Override
            public void onClick(View textView) {
                Open_Privacy_policy();
            }
        ...
        ssplo.setSpan(clickableSpanpoli, 34, ssplo.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        TextView textViewpolicy = (TextView) findViewById(R.id.login_terms_condition_txt_policy);
        textViewpolicy.setText(ssplo);
        textViewpolicy.setClickable(true);
    ...
    public void Open_TermsandCond(){
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Variables.terms_condi));
        startActivity(browserIntent);
    }
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                if(userdata.has("mobile"))
                    editor.putString(Variables.mobile,userdata.optString("mobile"));
