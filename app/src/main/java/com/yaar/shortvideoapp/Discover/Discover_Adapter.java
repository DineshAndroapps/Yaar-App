package com.yaar.shortvideoapp.Discover;
...
//                        }
//                    }
                    Picasso.get().load(item.thum).placeholder(R.drawable.image_placeholder) .resize(400,500).centerCrop().into(holder.video_thumbnail);
