package com.yaar.shortvideoapp.Firebase_Notification;
...
public class Notification_Receive extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            video_id = remoteMessage.getData().get("video_id");
    ...
    private class sendNotification extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if (MainMenuActivity.mainMenuActivity != null && action_type.equalsIgnoreCase("message")) {
    ...
    public void ShowNotification(Context context, String title, String message, Bitmap bitmap) {
        ...
        notificationIntent.putExtra("video_id", video_id);
