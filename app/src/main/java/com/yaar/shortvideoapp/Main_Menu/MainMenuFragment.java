...
import com.yaar.shortvideoapp.Notifications.Notification_F;
...
import com.yaar.shortvideoapp.Home.Home_F;
import com.yaar.shortvideoapp.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.yaar.shortvideoapp.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.yaar.shortvideoapp.Profile.Profile_Tab_F;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    public MainMenuFragment(MainMenuActivity.onPayment onPayment) {
        super();
    ...
    public void setCategory(ArrayList<Discover_Get_Set> datalist) {
        ((Home_F) adapter.registeredFragments.get(0)).setCategory(datalist);
    }
            ...
            PreviewEngine.from(this)
                    ...
                    .setPreviewCaptureListener((path, type) -> {
                        if (type == OnPreviewCaptureListener.MediaTypePicture) {
                            ...
                            Intent intent = new Intent(getActivity(), Preview_Video_A.class);
                            startActivity(intent);
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_gray));
        //title1.setText("");
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.trending_up));
        ...
        imageView4.setImageDrawable(getResources().getDrawable(R.drawable.notifications_none));
        ...
        imageView5.setImageDrawable(getResources().getDrawable(R.drawable.profile));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.trending_up));
                    ...
                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.notifications_none));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
                    case 4:
...
//                editor.putString(Variables.u_id,"101625848518981586766");
