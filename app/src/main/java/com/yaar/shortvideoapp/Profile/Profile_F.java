...
public class Profile_F extends RootFragment implements View.OnClickListener {
    ...
    View view;
    Context context;
    public TextView follow_unfollow_btn, txt_bio, txt_total_videos;
...
//                        .build());
       ...
       /* adView = view.findViewById(R.id.bannerad);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if (Home_F.pagination_progress != null) {
                    if (Home_F.pagination_progress.getVisibility() == View.VISIBLE) {
                        Home_F.pagination_progress.setVisibility(View.GONE);
                    } else {
    ...
    public View init() {
        ...
        txtSendmsg = view.findViewById(R.id.txtSendmsg);
        txtSendmsg.setOnClickListener(this);
    ...
    private void setupTabIcons() {
        ...
        txtTabname1.setText(getString(R.string.videos));
        ...
        txtTabname2.setText(getString(R.string.likes));
        // imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_liked_video_gray));
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    result = new UserVideo_F(false, user_id, "0");
                    break;
                case 1:
