...
public class VideoSound_A extends BaseActivity implements View.OnClickListener {
        ...
        switch (v.getId()){
            ...
            case R.id.create_btn:
                if(audio_file!=null && audio_file.exists()) {
                    ...
                    Toast.makeText(VideoSound_A.this , "This sound is not Avilable.Please choose another Sound",Toast.LENGTH_LONG).show();
