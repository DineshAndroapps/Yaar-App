package com.yaar.shortvideoapp.Video_Recording.GallerySelectedVideo;
...
import static com.yaar.shortvideoapp.Video_Recording.Video_Recoder_A.Sounds_list_Request_code;
...
public class GallerySelectedVideo_A extends BaseActivity implements View.OnClickListener,Player.EventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            music_name = getIntent().getStringExtra("name");
            add_sound_txt.setText(""+music_name);
            PreparedAudio();
        }
        else {
    ...
    public void Set_Player(){
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(this,
                Util.getUserAgent(this, "MegaPlay"));
    ...
    public void Merge_withAudio(){
        ...
        try {
            Functions.copyFile(new File(path),
                    new File(Variables.outputfile));
        } catch (IOException e) {
            e.printStackTrace();
        }

        String audio_file;
        audio_file = Variables.app_showing_folder +Variables.SelectedAudio_AAC;
