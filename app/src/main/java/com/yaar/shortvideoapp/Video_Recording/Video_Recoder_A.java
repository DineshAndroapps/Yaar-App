package com.yaar.shortvideoapp.Video_Recording;
...
import com.yaar.shortvideoapp.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
...
public class Video_Recoder_A extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((View) findViewById(R.id.lnradvancecamera)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intent = new Intent(Video_Recoder_A.this, CameraViewFragment.class);
//                startActivity(intent);
//                finish();

                if(getIntent().hasExtra("sound_name"))
                {
                    previewCamera(Variables.Selected_sound_id,getIntent().getStringExtra("sound_name"));
                }
                else {
                    previewCamera(Variables.Selected_sound_id,"name");
                }
        ...
        ((View) findViewById(R.id.video_image)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intent = new Intent(Video_Recoder_A.this, CameraViewFragment.class);
//                startActivity(intent);
//                finish();
        ...
        if(intent.hasExtra("sound_name")){
            ...
            music_name = intent.getStringExtra("sound_name");
            PreparedAudio();
        }
    ...
    private void initResources() {
        new Thread(() -> {
            ResourceHelper.initAssetsResource(Video_Recoder_A.this);
            FilterHelper.initAssetsFilter(Video_Recoder_A.this);
            MakeupHelper.initAssetsMakeup(Video_Recoder_A.this);
        }).start();
    }


    private void previewCamera(String tag,String name) {
            ...
            if (requestCode == Sounds_list_Request_code) {
                if (data != null) {
                    ...
                    if (data.getStringExtra("isSelected").equals("yes")) {
                        ...
                        music_name = data.getStringExtra("sound_name");
                ...
                try {
                    ...
                    intent.putExtra(TrimmerConstants.DESTINATION,Variables.app_showing_folder);
                    ...
                    public void onCompleted() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                {
                                    intent.putExtra("name",music_name);
                                }
...
//        }
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("Alert")
                .setMessage("If you go Back you will lose your video ?")
