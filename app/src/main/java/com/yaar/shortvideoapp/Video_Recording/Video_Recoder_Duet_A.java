...
public class Video_Recoder_Duet_A extends BaseActivity implements View.OnClickListener{
...
//                    cameraView.captureVideo(file);
    ...
    public void Check_done_btn_enable(){
        if(sec_passed>(Variables.min_time_recording/1000)) {
            done_btn.setImageDrawable(getResources().getDrawable(R.drawable.ic_done));
