...
public class Watch_Videos_Adapter extends RecyclerView.Adapter<Watch_Videos_Adapter.CustomViewHolder > {
    ...
    public void onBindViewHolder(final Watch_Videos_Adapter.CustomViewHolder holder, final int i) {
        ...
        Picasso.get().
            ...
            holder.img_temp.setVisibility(View.VISIBLE);
            Glide.with(context)
                    .load(item.thum)
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView user_pic,sound_image,varified_btn,img_temp,img_sound_img;

        LinearLayout like_layout,comment_layout,shared_layout,sound_image_layout,sound_layout,duet_layout;
