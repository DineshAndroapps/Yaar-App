...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String song_id = intent.getStringExtra("tag");

        if (null == savedInstanceState && mPreviewFragment == null) {
            mPreviewFragment = new CameraPreviewFragment(name,song_id);
    ...
    /**
     *Face detection SDK verification, you can replace it with your own SDK
     */
    ...
    /**
     * Home button monitoring service
     */
    private BroadcastReceiver mHomePressReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_CLOSE_SYSTEM_DIALOGS)) {
                ...
                // The preview needs to be stopped when the home button is clicked to prevent the camera from being held in the background
