...
public class Merge_Video_Audio extends AsyncTask<String,String,String> {
    ...
    Context context;
    CameraPreviewPresenter.onMergeSuccessFull mergeSuccessFull;

    String audio,video,output,draft_file;

    public Merge_Video_Audio(Context context, CameraPreviewPresenter.onMergeSuccessFull mergeSuccessFull){
        this.context=context;
        this.mergeSuccessFull=mergeSuccessFull;
...
//        context.startActivity(intent);
        ...
        mergeSuccessFull.onSuccess(Variables.outputfile2);
    }
