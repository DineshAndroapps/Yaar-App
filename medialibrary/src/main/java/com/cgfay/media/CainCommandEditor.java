...
public class CainCommandEditor {
    ...
    public CainCommandEditor() {
        HandlerThread thread = new HandlerThread("cain_command_editor");
        thread.start();
    ...
    public static String[] mp3ToConvertAAC(@NonNull String srcPath, @NonNull String dstFile) {
        ...
        cmdList.add("-c:a");
        cmdList.add("libfdk_aac"); // 这里使用libfdk-aac进行转码
