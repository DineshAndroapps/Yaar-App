...
import com.cgfay.uitls.adapter.Sounds_Adapter;
import com.cgfay.uitls.bean.MusicData;
import com.cgfay.uitls.utils.ApiRequest;
import com.cgfay.uitls.utils.Callback;
import com.cgfay.uitls.utils.Functions;
import com.cgfay.uitls.utils.Sound_catagory_Get_Set;
import com.cgfay.uitls.utils.Sounds_GetSet;
...
public class DiscoverTestFragment extends Fragment implements Player.EventListener {
    ...
    public DiscoverTestFragment(LocalMusicAdapter.OnMusicItemSelectedListener onMusicItemSelectedListener) {
        this.onMusicItemSelectedListener = onMusicItemSelectedListener;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_discover_test, container, false);
        context=getContext();
    ...
    private void Call_Api_For_get_allsound() {
        ...
        try {
            parameters.put("fb_id", "116680753068957760625");
...
//                getActivity().finish();
    ...
    MediaPlayer audio;
    public  void PreparedAudio(String id, String sound_name){
        ...
        if(file.exists()) {
            ...
            if(file_duration<Variables.max_recording_duration){
                ...
                MusicData musicData = new MusicData(Long.parseLong(id),sound_name,file.getAbsolutePath(),seconds);
    ...
    private void Call_Api_For_Fav_sound(int pos, final Sounds_GetSet item) {
        ...
        if (Variables.sharedPreferences.getString(Variables.u_id,"0") != null) {
