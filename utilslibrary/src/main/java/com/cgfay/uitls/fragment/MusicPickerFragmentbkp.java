 ...
 * 音乐选择页面
 */
public class MusicPickerFragmentbkp extends AppCompatDialogFragment implements LocalMusicScanner.MusicScanCallbacks,
    ...
    private void initView(@NonNull View view) {
        ...
        LocalMusicAdapter.OnMusicItemSelectedListener onMusicItemSelectedListener = new LocalMusicAdapter.OnMusicItemSelectedListener() {
            @Override
...
//                adapter = new ViewPagerAdapter(getResources(), getFragmentManager());
