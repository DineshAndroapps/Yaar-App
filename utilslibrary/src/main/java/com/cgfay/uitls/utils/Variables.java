...
public class Variables {
    ...
    public static String video_compress=app_folder + "video_compress.mp4";
...
//    public static final String base_url=main_domain+"aps/";
    public static final String base_url=main_domain+"aps_dev/";
    public static final String api_domain =base_url+"indexV1.php?p=";

    public static final String HASTAG = "http://167.71.232.99/palanglightapp/panel/api/banner/list";
    public static final String IMGPATH = "http://167.71.232.99/palanglightapp/panel/upload/";
